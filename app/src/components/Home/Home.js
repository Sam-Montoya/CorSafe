			...
			<div className="home_container">
				<section className="home_header">
					<h1 style={{ fontWeight: 'light' }}>
						cor<strong style={{ fontWeight: 'bolder' }}>safe</strong>
					</h1>
					...
					<div id="contactme" className="home_contactcontainer">
						...
						<div className="home_contactsquares">
							<a
								...
								href="https://github.com/Sam-Montoya?tab=repositories">
								<section className="home_github">
							...
							<section
								...
								onClick={() => this.setState({ contactText: 'samuel.montoya1073@gmail.com' })}>
								<i className="fa fa-envelope-o fa-5x" aria-hidden="true" />
							</section>

							<section
								className="home_phone"
								onClick={() => this.setState({ contactText: '801-879-7527' })}>
							...
							<a
								target="_blank"
								rel="noopener noreferrer"
								href="https://www.facebook.com/wheatly.montoya">
								<section className="home_facebook">
